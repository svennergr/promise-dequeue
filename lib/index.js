...
(function(root, factory) {
    ...
    Queue.prototype.dequeue = function(force = false) {
        ...
        try {
            ...
            // let timeoutHandle, timeoutResolve, timeoutPromise;
            // if (this.options.itemTimeout) {
            //     timeoutPromise = new LocalPromise((resolve, reject) => {
            //         timeoutResolve = resolve;
            //         timeoutHandle = setTimeout(() => {
            //             reject(
            //                 new TimeoutError(`${this.options.itemTimeout}ms`)
            //             );
            //         }, this.options.itemTimeout);
            //     });
            // } else {
            //     // if no timeot is set, just create an empty promise, so every reject and resolves comes from the job
            //     timeoutPromise = new LocalPromise();
            // }
